#ifndef SRC_SIMTRADE_CTPORDER_MESSAGE_SENDER_H_
#define SRC_SIMTRADE_CTPORDER_MESSAGE_SENDER_H_
...
#include "simtrade/ctporder/token_manager.h"
...
#endif  // SRC_SIMTRADE_CTPORDER_MESSAGE_SENDER_H_
